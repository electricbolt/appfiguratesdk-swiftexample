...
@objcMembers class ExampleConfiguration: APLConfiguration {
    ...
    @StringPropertyListEdit(regex: #"https://[\w\.-]+\.electricbolt.co.nz/.*"#, description: "String - textfield with regex, customizable list", restart: false, values: ["Dev":"https://dev.electricbolt.co.nz/list", "Test":"https://test.electricbolt.co.nz/list", "Prod":"https://m.electricbolt.co.nz/list"])
